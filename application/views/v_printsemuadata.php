  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section class="wrapper" style="margin-top : 1%">
        <h3><i class="fa fa-angle-right"></i> Print Laporan</h3>
            
            <!-- BASIC FORM ELELEMNTS -->
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i>  Print Data Berdasar Tanggal</h4>
                      <form class="form-horizontal style-form" method="post" action="/kausar/16WF08_inventory/index.php/C_printsemua/ambildata/">

                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tanggal Awal</label>
                              <div class="col-sm-10">
                                  <input type="date" class="form-control" name="tawal" id="tawal" placeholder="Masukkan Jenis Usaha"><span class="help-block"> Keterangan : Tanggal Data awal </span>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="date" class="form-control" name="tahir" id="tahir" placeholder="Masukkan Jenis Usaha"><span class="help-block"> Keterangan : Masukkan Tanggal Data akhir yang akan di print </span>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <select name = "tabelnya" class="form-control" required>
                                      <option>---Pilih Data---</option>
                                      <option value="barang">Data Barang</option>
                                      <option value="t_inbarang">Data Barang Masuk</option>
                                      <option value="t_outbarang">Data Barang Keluar</option>
                                      <option value="perubahan_stok">Data Barang Berubah</option>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-lg-4">
                                  <button class="btn btn-theme btn-block" type="submit"><i class="fa fa-lock"></i> Tambahkan Data</button>
                              </div>
                          </div>
                      </form>
                  </div>
